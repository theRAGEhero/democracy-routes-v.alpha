      ...
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        <div className="text-center space-y-6 mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Record or upload audio files to get local transcriptions with timestamps
          </p>
        ...
        <div className="space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                View transcriptions with timestamps and export options
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 text-center bg-muted/50 rounded-lg p-12">
          ...
          <p className="text-muted-foreground mb-6">
            Create your first round and experience local transcriptions
          </p>
          <Link href="/rounds/new">
            <Button size="lg">
              <Plus className="mr-2 h-5 w-5" />
