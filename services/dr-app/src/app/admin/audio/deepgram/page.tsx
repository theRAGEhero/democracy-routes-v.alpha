...
export default async function AdminDeepgramEmbedPage() {
  ...
  const embedUrl = "/audio-admin/deepgram/";
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-600">Embedded Deepgram-modular interface.</p>
        </div>
