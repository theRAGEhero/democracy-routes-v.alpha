...
export async function POST(
  ...
  if (needsGuestInvite) {
    ...
    const guestLink = `${appBaseUrl}/guest/flows/${invite.token}`;
    ...
    const emailResult = await sendMail({
      ...
      text: `You have been invited to the template ${plan.title}. Join without registration: ${guestLink}. Register: ${registerLink}`
    });
